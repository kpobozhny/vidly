...
describe('/api/genres', () => {
    ...
    describe('GET /:id', () => {
        ...
        it('should return a genre if a valid id is passed', async () => {
            ...
            const res = await request(server).get('/api/genres/' + genre._id).set('x-auth-token', token);
    ...
    describe('POST /', () => {
        ...
        it('should return 400 a genre is less than 5 characters', async () => {
            name = '1234';
            const res = await exec();
            expect(res.status).toBe(400);
        });

        it('should return 400 a genre is more than 50 characters', async () => {
